...
- produkčně jsou aktivní (stav 2026-09-23) tyto automations: **Syllonaut · Onboarding**, **Syllonaut · First live → Paid**, **Syllonaut · Free quota near limit**, **Syllonaut · Free quota reached**, **Syllonaut · Paid onboarding** a **Syllonaut · Win-back after cancellation**; **Syllonaut · Renewal tips before billing period ends** je připravená, ale **disabled**;
...
- dočasné review/test automations (`TEST · …`) jsou po testu **disabled**; produkční automations uvedené výše zůstávají **enabled** (kromě Renewal tips).
