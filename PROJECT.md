...
Aktualizováno: 2026-09-19 pro interní verzi 0.9.34 nad veřejným releasem 0.9.30 — opraven přechod po generování v průvodci „První let“. Stav průvodce má schema v2 a migruje starý číselný stav tak, aby rozběhnutý průchod na detailu lekce skončil na kroku kontroly náhledu. Událost `lesson-created` navíc už neposouvá stav relativně o jeden krok, ale deterministicky nastaví „Prohlédněte si lekci“, takže starší localStorage ani vložení nového kroku nemůže uživatele přeskočit rovnou na celkovou AI úpravu. Veřejně zobrazovaná verze na dashboardu zůstává 0.9.30.
