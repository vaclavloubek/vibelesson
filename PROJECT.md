...
Aktualizováno: 2026-09-20 — interní verze **0.9.66** dokončuje učitelský workflow AI integrity alertu. Vysoké podezření na využití generativní AI dál nikdy samo nemění body a pouze přesouvá odpověď do `needs_review`; učitel nyní může po zobrazení konkrétních signálů explicitně a potvrzovaně zvolit **„Potvrdit nepovolené využití AI → 0 bodů“**. Studentovi se žádná automatická kontrolní otázka nevytváří ani nezobrazuje. Detekční baseline 0.9.65, včetně minimálně 280 znaků a nejméně dvou konkrétních signálů pro `high`, zůstává beze změny. Veřejně zobrazovaná verze na dashboardu zůstává 0.9.30.
