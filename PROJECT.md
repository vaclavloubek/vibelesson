...
Aktualizováno: 2026-09-19 pro interní verzi 0.9.36 nad veřejným releasem 0.9.30 — opraven náhodný pád při spuštění live hodiny. Generátor sedmimístného join kódu používal 32hodnotovou bitovou masku nad 31znakovou abecedou, takže přibližně v 19,9 % generování mohl vytvořit neplatný řetězec s `undefined`, který databázový CHECK odmítl a API vrátilo obecné 500. Generátor nyní používá kryptografický `randomInt` přímo v rozsahu platné abecedy; regresní live-resilience kontrola zakazuje návrat k původnímu bitmaskovému výběru. Veřejně zobrazovaná verze na dashboardu zůstává 0.9.30.
