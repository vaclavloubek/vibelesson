...
Aktualizováno: 2026-09-19 pro interní verzi 0.9.38 nad veřejným releasem 0.9.30 — opraven responzivní layout startovní zóny v Prezentačním režimu. Pravý blok s adresou a kódem se nyní může bezpečně zmenšit, sedmimístný kód zůstává na jednom řádku s menším adaptivním fontem a rozumnějším letter-spacingem a pod 1200 px se join karta skládá vertikálně (QR nad detaily). Cílem je zabránit přetékání kódu mimo vymezený panel na projektorech a menších 16:9 rozlišeních. Veřejně zobrazovaná verze na dashboardu zůstává 0.9.30.
