...
- **Právní audit:** vyřešeno **LEGAL-001 až LEGAL-018 a LEGAL-020 až LEGAL-023** (23. 9. LEGAL-013 až 018, 020 a 021: #293, #294, #296, #298, #300, #302, #304; 24. 9. LEGAL-022; 25. 9. LEGAL-023). Aktuální **VOP 1.12** (`2026-09-25-v13`, účinné od 25. 9. 2026, článek 5a o balíčcích návrhů hodnocení od AI; souhlasy v4–v12 zůstávají dostatečné), **Privacy Notice 1.9**, **DPA 1.4** (`2026-09-25-dpa-v5`), Neon migrace **0011** (evidence reklamací) a **0012** (body z AI až po potvrzení učitelem) aplikované v produkci. Otevřené: **LEGAL-019** (DPH/OSS — daňový poradce); **LEGAL-021** (AI Act) vyřešen v 0.9.105, posouzení potvrdit právníkem a do 2. 12. 2026 vyřešit označení textu generovaného AI (čl. 50 odst. 2).
