...
Aktualizováno: 2026-09-19 pro interní verzi 0.9.23 — hotfix samoobslužné správy předplatného po prvním produkčním načtení: odstraněna zbytečná závislost renderu na Stripe Prices API, ceny Teacher / Teacher Pro mají jeden sdílený katalog s Ceníkem, zrušené subscription se na stránce nepovažují za aktivní a LIVE webhook před DB syncem ověřuje aktuální canonical subscription stav ve Stripe. Veřejně zobrazovaná verze na dashboardu zůstává 0.9.20.
