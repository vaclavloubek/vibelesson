...
Aktualizováno: 2026-09-19 pro interní verzi 0.9.26 — druhý hotfix tisku pracovních listů po reálném Safari PDF testu: worksheet print CSS už vůbec nemanipuluje s body-level wrappery ani #main-content a cookie UI se na worksheet route nerenderuje. Tisk tak obsahuje pouze worksheet dokument a vlastní skrytý toolbar; ochrana proti rozdělení cvičení mezi stránky zůstává zachovaná. Veřejně zobrazovaná verze na dashboardu zůstává 0.9.20.
