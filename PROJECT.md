...
Aktualizováno: 2026-09-20 — interní verze **0.9.68** rozšiřuje AI integrity ochranu z 0.9.65–0.9.67 o krátkou kontrolní otázku pro individuální odpovědi s vysokým podezřením. Detekce sama nikdy nesnižuje body. Student má 60 sekund od skutečného zobrazení otázky na stručnou odpověď vlastními slovy; učitel vidí otázku, odpověď nebo expiraci a teprve poté může využít existující potvrzovanou akci **„Potvrdit nepovolené využití AI → 0 bodů“**. Týmové odpovědi zůstávají bez automatické individuální otázky. Zvýraznění integrity ochrany v Ceníku z 0.9.67 zůstává zachováno. Veřejně zobrazovaná verze na dashboardu zůstává 0.9.30.
...
### Kontrolní otázka AI integrity 0.9.68 — 2026-09-20

- navazuje na 0.9.66 a zachovává explicitní učitelské potvrzení před nastavením 0 bodů;
- `high` je přijato pouze u odpovědi od 280 znaků, při nejméně dvou konkrétních signálech a při validní krátké kontrolní otázce;
- u individuálních odpovědí se vytvoří jedna otázka přímo navázaná na tvrzení či pojem z původní odpovědi; týmové odpovědi ji automaticky nedostávají;
- 60sekundový limit začíná až prvním skutečným zobrazením otázky studentovi;
- student challenge API je svázané s participant tokenem, session a evaluation ID; odpověď mimo časové okno server odmítne;
- učitel v grading frontě vidí otázku, odpověď nebo expiraci; detekce ani nezodpovězená otázka sama automaticky nemění body;
- zvýrazněný benefit AI integrity ochrany v Teacher Pro, School a Campus z 0.9.67 zůstává zachován;
...
- **0.9.68 interní — AI integrity challenge + teacher-confirmed zero** — vysoké podezření u individuální odpovědi spouští krátkou 60s kontrolní otázku; odpověď/expiraci vidí učitel a pouze jeho explicitní potvrzení může nastavit 0 bodů. Týmové odpovědi se automaticky individuálně neověřují. Veřejně zobrazovaná verze zůstává 0.9.30.\n- **0.9.67 interní — zvýraznění AI integrity ochrany v Ceníku** — Teacher Pro, School a Campus nově zobrazují hned pod AI hodnocením samostatně zvýrazněnou ochranu proti nepovolenému využití AI ve studentských odpovědích; CZ/EN. Veřejně zobrazovaná verze zůstává 0.9.30.
