...
Aktualizováno: 2026-09-19 pro interní verzi 0.9.31 nad veřejným releasem 0.9.30 — kontextový průvodce „První let“ nově umožňuje návrat na předchozí dostupný krok v aktuální kapitole, po návratu nenutí opakovat už úspěšně provedenou akci a hlavní pracovní plochy mají lokální tlačítko „?“ pro spuštění nápovědy přesně v daném kontextu. Globální vstup „Průvodce Syllonautem“ v uživatelském menu zůstává. Stav zůstává per-user v localStorage; DB, RLS, Auth ani live-control protokol se nemění. Veřejně zobrazovaná verze na dashboardu zůstává 0.9.30.
