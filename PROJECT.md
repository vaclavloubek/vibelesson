...
Aktualizováno: 2026-09-19 pro interní verzi 0.9.32 nad veřejným releasem 0.9.30 — první krok průvodce „První let“ nově zvýrazňuje celý formulář tvorby lekce, nikoli jen pole volného popisu. Uživatel tak může bez opuštění průvodce vyplnit jazyk, cílovku, délku, velikost týmu, tón i volitelné podklady; až druhý krok samostatně zvýrazní tlačítko pro vytvoření lekce. Veřejně zobrazovaná verze na dashboardu zůstává 0.9.30.
