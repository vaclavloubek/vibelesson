...
- `app/api/organizations/invitations/accept/route.ts` po úspěšném přijetí pozvánky volá v `after()` `emitOrganizationMemberJoined(userId)`; členové interní testovací organizace event nedostanou;
