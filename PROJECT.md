...
Aktualizováno: 2026-09-19 pro interní verzi 0.9.28 — pracovní listy mají produkční acceptance COMPLETE / PASS. Teacher Pro může z uložené lekce vytvořit studentskou nebo učitelskou variantu, vybrat aktivity, zvolit prostor pro odpovědi a stáhnout skutečné serverově generované PDF; aktivity se při tisku nedělí mezi stránky, pokud se samy vejdou na A4, a při částečném výběru se přečíslují souvisle od 1. Veřejně zobrazovaná verze na dashboardu zůstává 0.9.20.
