...
Aktualizováno: 2026-09-19 pro interní verzi 0.9.41 nad veřejným releasem 0.9.30 — opraven spotlight kroku „Vytvořit týmy“ v kapitole 2 průvodce „První let“. Kotva `live-team-create` už není pouze na tlačítku, ale obaluje celý panel pro vytvoření týmů, takže během průvodce zůstává aktivní pole „Počet týmů“ i samotné tlačítko. Pokud už týmy existují, kotva se nevykreslí a volitelný krok se může bezpečně přeskočit. Veřejně zobrazovaná verze na dashboardu zůstává 0.9.30.
