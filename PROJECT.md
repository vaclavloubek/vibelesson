...
- **Právní audit:** vyřešeno **LEGAL-001 až LEGAL-018 a LEGAL-020 až LEGAL-024** (23. 9. LEGAL-013 až 018, 020 a 021: #293, #294, #296, #298, #300, #302, #304; 24. 9. LEGAL-022; 25. 9. LEGAL-023; 26. 9. LEGAL-024). Aktuální **VOP 1.13** (`2026-09-26-v14`, účinné od 26. 9. 2026; článek 5a o balíčcích návrhů hodnocení od AI, článek 6 doplněn o ukončení předplatného při plném vrácení platby; souhlasy v4–v13 zůstávají dostatečné), **Privacy Notice 1.10** (26. 9. 2026, evidence potvrzení upozornění Free na jedno živé použití lekce), **DPA 1.4** (`2026-09-25-dpa-v5`), Neon migrace **0011** (evidence reklamací) a **0012** (body z AI až po potvrzení učitelem) aplikované v produkci. Otevřené: **LEGAL-019** (DPH/OSS — daňový poradce); **LEGAL-021** (AI Act) vyřešen v 0.9.105, posouzení potvrdit právníkem a do 2. 12. 2026 vyřešit označení textu generovaného AI (čl. 50 odst. 2).
