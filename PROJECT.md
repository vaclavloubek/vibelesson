...
Aktualizováno: 2026-09-21 — interní verze **0.9.81** uzavírá **LEGAL-003**: AI hodnocení už není prodáváno jako neurčitá funkce se skrytým nákladovým stropem. Teacher Pro má jasnou kvótu 60 AI hodnocení, School 300 společně a Campus 750 společně za období; účet ukazuje zbývající počet a interní dolarový circuit breaker má výraznou rezervu nad veřejnou početní kvótou. Předchozí změny 0.9.80 zůstávají zachované. Veřejně zobrazovaná verze na dashboardu zůstává 0.9.30.
...
### Veřejné kvóty AI hodnocení 0.9.81 — 2026-09-21
...
- interní dolarový safety circuit breaker zůstává neveřejný a je nastaven na **$12 / $60 / $150**; konzervativní in-flight rezervace je **$0,10**, takže finanční pojistka má 2× headroom proti plnému vyčerpání veřejné početní kvóty;
- kontrola produkčních nákladů při rozhodnutí: **65** hodnocení s nenulovou cenou, průměr **~$0,0143**, p95 **~$0,0261**, maximum **~$0,0340**; veřejný početní limit je proto za současných nákladů dominantní hranicí;
- Security Advisor po produkční migraci nepřidal novou veřejnou privileged surface; `private.reserve_ai_grading_budget` zůstává bez EXECUTE pro klientské role a stávající warningy projektu jsou beze změny;
- regresní kontrakty **scripts/verify-ai-grading-budget.mjs** a **scripts/verify-billing-lifecycle-email.mjs** hlídají DB limity, circuit-breaker headroom, Pricing, účetní UI i aktivační e-mail;
...
- **[LEGAL-003 — RESOLVED 0.9.81] AI grading měl skryté safety stropy a neurčitý zákaznický příslib.** Opraveno: Teacher Pro má veřejnou kvótu **60 AI hodnocení / období**, School **300 společně / měsíc** a Campus **750 společně / měsíc**. `get_ai_quota()` vrací i `grading_used`, `grading_limit`, `grading_remaining`, `grading_enabled` a `grading_unlimited`; účet a stránka Předplatné zobrazují zbývající grading kvótu. Ceník vysvětluje, že jedno AI vyhodnocení jedné bodované odpovědi čerpá jednu jednotku a AI přehodnocení čerpá další, zatímco ruční hodnocení zůstává po vyčerpání dostupné. Interní circuit breaker je **$12 / $60 / $150** s konzervativní rezervací **$0,10** na rozpracované hodnocení, tedy 2× nad maximální rezervovanou cenou veřejné početní kvóty; podle 65 dosavadních produkčně oceněných hodnocení je průměr ~$0,0143, p95 ~$0,0261 a maximum ~$0,0340.
...
- **[LEGAL-006] Starší účty nemají doložené přijetí aktuálních VOP.** V okamžiku auditu existovaly v produkčním Auth **3 účty a 0/3** mělo registrační metadata aktuálního acceptance key `2026-09-21-v1`. Placený checkout může mít vlastní doklad, ale pro Free používání a obecná pravidla VOP není bezpečné předpokládat automatickou závaznost nové verze. **Náprava:** jednorázový re-consent aktuálních podmínek pro existující účty před dalším relevantním použitím, s append-only serverovým auditem.
...
- **[LEGAL-011] VOP neuvádějí telefonní číslo poskytovatele.** U spotřebitelské distanční smlouvy patří telefon mezi předsmluvní kontaktní informace. **Náprava:** doplnit funkční telefon do VOP a checkout/legal kontaktních údajů.
