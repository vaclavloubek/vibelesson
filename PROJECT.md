...
Aktualizováno: 2026-09-19 pro interní verzi 0.9.40 nad veřejným releasem 0.9.30 — opraven UX handoff mezi učitelským a Prezentačním oknem v kapitole 2 průvodce „První let“. Po kliknutí na Prezentační režim se krok 2/7 nově zobrazí přímo v novém studentském okně, kde vysvětlí přesun na projektor / druhý displej a návrat k původnímu učitelskému oknu. Tlačítko „Hotovo – pokračovat“ synchronizuje guide state zpět do učitelského okna na krok 3/7 pomocí BroadcastChannel s localStorage/storage-event fallbackem; `noreferrer` zůstává zachované. Veřejně zobrazovaná verze na dashboardu zůstává 0.9.30.
