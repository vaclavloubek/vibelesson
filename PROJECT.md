...
Aktualizováno: 2026-09-19 pro veřejný release 0.9.30 — Syllonaut nově obsahuje kontextový průvodce „První let“ pro nejkratší cestu od vytvoření lekce přes AI úpravy, úpravu jedné aktivity, spuštění live hodiny a týmů až po prezentační režim a vyhodnocení. Průvodce používá tmavý overlay se spotlightem na skutečné ovládací prvky, potvrzené kroky čekají na úspěšné dokončení operace a lze jej kdykoli znovu spustit z uživatelského menu. Stav první verze průvodce je per-user uložen lokálně v prohlížeči; nezasahuje do DB, RLS, Auth ani live-control protokolu. Veřejně zobrazovaná verze na dashboardu je 0.9.30.
