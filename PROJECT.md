...
Aktualizováno: 2026-09-21 — interní verze **0.9.77** opravuje editaci počtu týmů před startem live hodiny: předvyplněnou hodnotu lze normálně celou smazat a přepsat, aniž by se prázdné pole samo změnilo na minimum 2. Tlačítko pro vytvoření týmů je aktivní jen pro platnou hodnotu 2–12. Přísný právní / ČOI launch audit z předchozího checkpointu zůstává otevřený. Veřejně zobrazovaná verze na dashboardu zůstává 0.9.30.
