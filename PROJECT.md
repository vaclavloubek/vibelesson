...
Aktualizováno: 2026-09-19 pro interní verzi 0.9.28 — pracovní list při výběru jen části aktivit nově přečísluje vybrané úkoly souvisle od 1. Původní pořadí bloků v lekci zůstává beze změny; nové číslování se týká pouze A4 náhledu a serverově generovaného PDF. Veřejně zobrazovaná verze na dashboardu zůstává 0.9.20.
