...
Aktualizováno: 2026-09-19 pro interní verzi 0.9.25 — správa předplatného je po hotfixech 0.9.23/0.9.25 produkčně načtená a ručně ověřená. LIVE restricted key má potřebný přístup k Subscriptions a Invoices; stránka se po nasazení načítá bez chyby. Admin bez aktivního Stripe subscription se správně zobrazuje jako „Administrátorský účet / plný přístup“, nikoli jako Free. Veřejně zobrazovaná verze na dashboardu zůstává 0.9.20.
...
- **0.9.25 interní hotfix** — účet s rolí `admin` má ve Správě předplatného vlastní stav „Administrátorský účet / plný přístup“ a nikdy se neprezentuje jako Free jen proto, že nemá aktivní Stripe subscription. Admin stav se vyhodnocuje serverově před jakýmkoli Stripe lookupem, takže není závislý na billing API ani na historickém acceptance subscription. Produkční acceptance 2026-09-19: stránka se po nasazení načetla a uživatel ručně potvrdil správné zobrazení admin stavu. Veřejně zobrazovaná verze zůstává 0.9.20.
