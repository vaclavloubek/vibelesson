...
- **Právní audit:** vyřešeno **LEGAL-001 až LEGAL-018 a LEGAL-020 až LEGAL-022** (23. 9. LEGAL-013 až 018, 020 a 021: #293, #294, #296, #298, #300, #302, #304; 24. 9. LEGAL-022). Aktuální **VOP 1.11** (`2026-09-24-v12`, souhlasy v4–v11 zůstávají dostatečné), **Privacy Notice 1.9**, **DPA 1.3** (`2026-09-24-dpa-v4`), Neon migrace **0011** (evidence reklamací) a **0012** (body z AI až po potvrzení učitelem) aplikované v produkci. Otevřené: **LEGAL-019** (DPH/OSS — daňový poradce); **LEGAL-021** (AI Act) vyřešen v 0.9.105, posouzení potvrdit právníkem a do 2. 12. 2026 vyřešit označení textu generovaného AI (čl. 50 odst. 2).
