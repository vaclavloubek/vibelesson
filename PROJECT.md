...
Aktualizováno: 2026-09-19 pro interní verzi 0.9.27 — pracovní listy přecházejí z nespolehlivého Safari `window.print()` exportu na skutečný PDF generátor uvnitř Syllonautu. PDF vzniká serverově z uloženého Lesson JSON, znovu ověřuje vlastníka i entitlement, používá vložený font a každou aktivitu drží jako nedělitelný blok. HTML A4 náhled zůstává, ale akce jsou nyní „Otevřít PDF pro tisk“ a „Stáhnout PDF“. Veřejně zobrazovaná verze na dashboardu zůstává 0.9.20.
