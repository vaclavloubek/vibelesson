...
- dočasné review/test automations (`TEST · …`) jsou po testu **disabled** (ověřeno 2026-09-25; `TEST · Org member joined review batch` byla do té doby omylem zapnutá a zdvojovala e-mail pro nové členy organizace); všech 9 produkčních automations uvedených výše je **enabled**.
