...
9. veřejný self-service školní billing je zapnutý od 2026-09-20 (`d13a5f2`). Starou proměnnou `STRIPE_LIVE_SCHOOL_BILLING_PUBLIC_ENABLED` od 0.9.151 nečte žádný kód; vypnutí jen přes `STRIPE_LIVE_SCHOOL_BILLING_EMERGENCY_DISABLED=true`.
