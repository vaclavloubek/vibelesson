...
Aktualizováno: 2026-09-19 pro interní verzi 0.9.37 nad veřejným releasem 0.9.30 — kapitola 2 průvodce „První let“ nově začíná vysvětlením Prezentačního režimu a přesunem studentského okna na projektor / druhý displej. Teprve potom průvodce vysvětlí, že kód a QR jsou aktivní už od vytvoření session a studenti se mohou připojovat průběžně, následují případné týmy a start hodiny. Kvůli změně pořadí live kroků má guide state schema v3 s migrací v2 → v3, aby rozběhnutý onboarding nepoužíval staré indexy. Veřejně zobrazovaná verze na dashboardu zůstává 0.9.30.
