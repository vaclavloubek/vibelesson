...
Aktualizováno: 2026-09-21 — interní verze **0.9.89** uzavírá **LEGAL-009**: veřejná nabídka už neslibuje ochranu před nepovoleným využitím AI. Teacher Pro, School a Campus používají přesný CZ/EN benefit upozornění na možné využití AI a viditelně vysvětlují, že jde o AI/heuristický signál pro kontrolu učitelem, nikoli důkaz; body se automaticky nemění. Veřejně zobrazovaná verze na dashboardu zůstává 0.9.30.
...
**Stav: OPEN.** Audit byl proveden z pohledu přísného spotřebitelského právníka / kontrolora proti aktuálním VOP, Ceníku, checkoutům, billing e-mailům, skutečným backendovým limitům a GDPR stránce. Níže uvedené body nejsou považovány za uzavřené pouhou existencí VOP; musí se odstranit rozpor mezi veřejnou nabídkou, potvrzením objednávky a skutečným plněním.\n\nPracovní implementace LEGAL-010: schválená hybridní varianta C klasifikuje změny služby, u podstatně nepříznivé změny přednostně zachovává bezpečnou původní verzi do konce zaplaceného období a jinak používá doložené oznámení na trvalém nosiči nejméně 30 dnů předem. Spotřebitelská výpověď zůstává dostupná bez nového souhlasu a vrací nevyužitou předplacenou část přes idempotentní Stripe workflow. Stav není RESOLVED; čeká na databázové, CI/Preview a produkční ověření.
...
- **[LEGAL-010 — IN PROGRESS] VOP řeší změny průběžné digitální služby příliš obecně.** Formulace „v souladu se zákonem / přiměřeně informován“ nestačí jako provozní postup pro nepříznivou změnu placeného tarifu během zaplaceného období. **Náprava:** definovat version/change workflow: důvod změny, textová notifikace předem, datum účinnosti, zachování původní verze kde možné a právo zákazníka ukončit smlouvu tam, kde ho zákon vyžaduje.
