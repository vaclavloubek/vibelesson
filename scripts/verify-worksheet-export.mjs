...
expect(worksheetCss.includes('break-inside:avoid-page')&&worksheetCss.includes('page-break-inside:avoid'),'Each worksheet activity must be kept on one printed page whenever it fits on A4.');
