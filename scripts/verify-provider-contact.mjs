...
assert.ok(legal.includes("TERMS_VERSION = '1.13'"));
assert.ok(legal.includes("TERMS_ACCEPTANCE_KEY = '2026-09-26-v14'"));
assert.ok(legal.includes("'2026-09-25-v13'"), 'Terms 1.12 access compatibility must be retained');
