...
assert.equal(params.get('metadata[syllonaut_terms_version]'), '2026-09-21-v1.0');
assert.equal(params.get('metadata[syllonaut_early_performance_requested]'), 'true');
assert.equal(params.get('subscription_data[metadata][syllonaut_terms_version]'), '2026-09-21-v1.0');
assert.equal(params.get('subscription_data[metadata][syllonaut_early_performance_requested]'), 'true');
