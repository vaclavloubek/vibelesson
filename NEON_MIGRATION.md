...
12. [Čeká] Portovat další úzkou server-only mutaci nebo související RPC až po samostatném owner/actor auditu; klientské Data API granty se neotevírají plošně.
