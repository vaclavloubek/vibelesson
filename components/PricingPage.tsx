...
const PLAN_TRANSLATIONS: Record<string, { description: string; features: string[] }> = {
  ...
  'teacher-pro': {
    ...
    features: [
      ...
      `${AI_GRADING_ALLOWANCES.teacher_pro} AI gradings of scored open, team and exit-ticket responses per allowance period`,
