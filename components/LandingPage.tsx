...
const copy = {
  cs: {
    ...
    heroTitle: 'Od nápadu k odučené hodině. S AI.',
    heroLead: 'Popište, co chcete učit. AI v Syllonautu připraví strukturovanou lekci, kterou upravíte přirozeným jazykem a rovnou vedete se studenty.',
  ...
  en: {
    ...
    heroTitle: 'From idea to live teaching. With AI.',
    heroLead: 'Describe what you want to teach. Syllonaut uses AI to create a structured lesson you can refine in natural language and run with students straight away.',
