...
export const LessonWorkModeSchema = z.enum(['individual', 'teams']);
...
export const LessonSchema = z.object({
  ...
  workMode: LessonWorkModeSchema.optional(),
...
export type LessonWorkMode = z.infer<typeof LessonWorkModeSchema>;
