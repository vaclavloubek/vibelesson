...
revoke all on function public.review_response_evaluation(uuid, integer, text) from public, anon;
grant execute on function public.review_response_evaluation(uuid, integer, text) to authenticated;
