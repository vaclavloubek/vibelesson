-- Preserve v1-v3 during the Terms 1.3 rolling deployment; historical acceptances remain unchanged.
-- Preserve v1/v2 during rolling deployment; historical acceptances remain unchanged.
...
as $function$
  select
    p_acceptance_key in ('2026-09-21-v1', '2026-09-21-v2', '2026-09-21-v3', '2026-09-21-v4')
    and exists (
      select 1
