-- Add Terms 1.4 for the public provider telephone while preserving v1-v4.
-- Existing Terms 1.3 acceptance remains sufficient for ordinary product access in the application;
-- new registrations, orders and explicit re-consents record v1.4 without rewriting history.
...
declare
  ...
  requested_terms_version text := case requested_terms_acceptance_key
    ...
    when '2026-09-21-v4' then '1.3'
    when '2026-09-21-v5' then '1.4'
    else null
  end;
...
as $function$
  select
    p_acceptance_key in ('2026-09-21-v1', '2026-09-21-v2', '2026-09-21-v3', '2026-09-21-v4', '2026-09-21-v5')
    and exists (
      select 1
