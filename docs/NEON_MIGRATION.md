...
- **Provozní pravidlo pro refundace ve Stripe dashboardu:** vždy vybrat důvod. Vrácení dvojité platby → **Duplicate** (předplatné běží dál). Jinak → **Requested by customer** (plná refundace platby za aktuální období předplatné okamžitě ukončí a účet přejde na Free). Bez vybraného důvodu se plná refundace aktuální faktury bere jako ukončení.
