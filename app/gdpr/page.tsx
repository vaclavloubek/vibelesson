    ...
    <main className={landing.page}>
      ...
      <article className={styles.page}>
        <div className={styles.hero}>
          ...
          <div className={styles.meta}>{ui('Verze 1.7 · účinná od 24. 9. 2026', 'Version 1.7 · effective from 24 September 2026')}</div>
        </div>
        ...
        <section>
          ...
          <ul>
            ...
            <li><strong>Cloudflare</strong> — Turnstile {ui('jen u formulářů přihlášení a registrace; Workers a Durable Objects pro řízení živých hodin v reálném čase (jméno studenta, obsah lekce, odpovědi studentů a týmů), s automatickým smazáním 7 dní po poslední aktivitě hodiny.', 'only on the sign-in and registration forms; Workers and Durable Objects for real-time control of live lessons (student name, lesson content, student and team responses), automatically deleted 7 days after the lesson’s last activity.')}</li>
        ...
        <section>
          ...
          <ul>
            ...
            <li>{ui('Kopie živé hodiny pro řízení v reálném čase (Cloudflare) se automaticky maže 7 dní po poslední aktivitě hodiny.', 'The real-time live-lesson copy (Cloudflare) is deleted automatically 7 days after the lesson’s last activity.')}</li>
