...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description: english
      ? 'How Syllonaut processes personal data, Terms acceptance records, cookies, account data, live lesson data, contact enquiries and marketing consent.'
      : 'Jak Syllonaut zpracovává osobní údaje, záznamy o přijetí obchodních podmínek, cookies, údaje z účtů, živých lekcí a marketingových souhlasů.',
    alternates: {
    ...
    <main className={landing.page}>
      ...
      <article className={styles.page}>
        <div className={styles.hero}>
          ...
          <div className={styles.meta}>{ui('Verze 1.2 · účinná od 21. 9. 2026', 'Version 1.2 · effective from 21 September 2026')}</div>
        </div>
